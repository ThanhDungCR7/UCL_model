...
class Appr(object):
    ...
    def train(self, t, xtrain, ytrain, xvalid, yvalid, data, input_size, taskcla):
        ...
        for e in range(self.nepochs):
            ...
            clock2 = time.time()
            print('| Epoch {:3d}, time={:5.1f}ms/{:5.1f}ms | Train: loss={:3.f}, acc={:5.1f}% |'.format(
                    e + 1,
            ...
            for task in range(t):
                ...
                valid_loss_t, valid_acc_t = self.eval(t, xvalid, yvalit)
    ...
    def train_epoch(self, t, x, y):
        ...
        r = np.arrange(x.size(0))
        np.random.shuffle(r)
        r = torch.LongTensor(r).cuda(r)
